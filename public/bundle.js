...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NotesNotesJs = __webpack_require__(202);

	var _NotesNotesJs2 = _interopRequireDefault(_NotesNotesJs);

	var _GithubReposJs = __webpack_require__(205);
	...
	var base = _reBase2['default'].createClass('https://reactnotetaker.firebaseio.com/');
	...
	var Profile = (function (_React$Component) {
	  ...
	  _createClass(Profile, [{
	    ...
	    value: function init() {
	      ...
	      _utilsHelpers2['default'].getGithubInfo(this.router.getCurrentParams().username).then(function (data) {
	        _this.setState({
	          repos: data.repos,
	          bio: data.bio
	        });
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'div',
	          { className: 'col-md-4' },
	          _react2['default'].createElement(_NotesNotesJs2['default'], { addNotes: this.handleAddNote.bind(this), username: username, notes: this.state.notes })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NotesList = __webpack_require__(203);

	var _NotesList2 = _interopRequireDefault(_NotesList);

	var _AddNotes = __webpack_require__(204);
	  ...
	  _createClass(Notes, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_AddNotes2['default'], { addNotes: this.props.addNotes }),
	...
	Notes.propTypes = {
	  ...
	  addNotes: _react2['default'].PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddNotes = (function (_React$Component) {
	  function AddNotes() {
	    _classCallCheck(this, AddNotes);

	    _get(Object.getPrototypeOf(AddNotes.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _inherits(AddNotes, _React$Component);

	  _createClass(AddNotes, [{
	    key: 'handleSubmit',
